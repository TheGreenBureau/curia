    ...
    return ((0, jsx_runtime_1.jsx)(react_day_picker_1.DayPicker, { showOutsideDays: showOutsideDays, className: (0, utils_1.cn)("p-3", className), classNames: {
            ...
            Chevron: ({ ...props }) => {
                switch (props.orientation) {
                    case "left":
                        return (0, jsx_runtime_1.jsx)(lucide_react_1.ChevronLeft, { className: "h-4 w-4" }, void 0);
                    case "right":
                        return (0, jsx_runtime_1.jsx)(lucide_react_1.ChevronRight, { className: "h-4 w-4" }, void 0);
                    case "up":
                        return (0, jsx_runtime_1.jsx)(lucide_react_1.ChevronUp, { className: "h-4 w-4" }, void 0);
                    default:
                        return (0, jsx_runtime_1.jsx)(lucide_react_1.ChevronDown, { className: "h-4 w-4" }, void 0);
                }
            },
        }, ...props }, void 0));
}
